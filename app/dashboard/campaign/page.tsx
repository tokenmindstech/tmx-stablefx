    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-3">
        <div className="rounded-lg bg-[#FFF5FC] p-2.5">
          <Megaphone className="h-5 w-5 text-[#FF4FD8]" />
        </div>
        <div>
          <h1 className="text-xl font-semibold text-foreground">Campaign</h1>
          <p className="text-sm text-muted-foreground">
            Manage and track your influencer marketing campaigns end-to-end.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border bg-muted/20 py-24 text-center">
        ...
        <p className="mt-1 text-xs text-muted-foreground max-w-xs">
          Create your first campaign to start managing influencer
          collaborations.
        </p>
      </div>
    </div>
