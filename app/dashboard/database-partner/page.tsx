      ...
      <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            All KOLs across campaigns. Assign them to a campaign from that
                ...
                paginated.map((kol, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <Link
                        href={`/dashboard/database-partner/${kol.id}`}
                    ...
                    {/* Niche */}
                    <td className="px-4 py-3 text-foreground">{kol.niche}</td>

                    {/* Region */}
                    <td className="px-4 py-3 text-foreground">{kol.region}</td>
