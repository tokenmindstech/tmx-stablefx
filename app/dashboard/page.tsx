    ...
    <Card className="border border-border/50 bg-card shadow-sm">
      ...
      <CardContent>
        ...
        <div className="flex items-center gap-1 mt-1">
          ...
          <p className={`text-xs ${changeType === "positive" ? "text-emerald-600" : "text-red-500"}`}>
            {change}
          </p>
                ...
                <Card className="col-span-3 border border-border/50 shadow-sm">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        { name: "New partner onboarded", time: "2 hours ago", type: "partner" },
                        { name: "Campaign launched", time: "4 hours ago", type: "campaign" },
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-medium text-foreground">9,234</span>
                      </div>
                      <div className="flex justify-between items-center">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-medium text-foreground">2.4M</span>
                      </div>
                      ...
                      <p className="text-xs text-muted-foreground text-center">68% of target reached</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
